    ...
    */
            ...
            function _decodeTabularData(_grid, ta) {
                ...
                for (var i = 0; i < clipRows.length; i++) {
                    if (clipRows[i] != "") clippedRange[i] = clipRows[i].split("\t");
                }
                ...
                for (var y = 0; y < destH; y++) {
                    ...
                    for (var x = 0; x < destW; x++) {
                        ...
                        if (desty < data.length && destx < grid.getColumns().length) {
                            ...
                            if (oneCellToMultiple) setDataItemValueForColumn(dt, columns[destx], clippedRange[0][0]);
                            else setDataItemValueForColumn(dt, columns[destx], clippedRange[y][x]);
