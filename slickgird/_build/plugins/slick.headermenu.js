    ...
    (function($) {
        ...
        function HeaderMenu(options) {
            ...
            function init(grid) {
                ...
                _grid = grid;
                _handler.subscribe(_grid.onHeaderRendered, handleHeaderRendered).subscribe(_grid.onBeforeHeaderDestroy, handleBeforeHeaderDestroy);
            ...
            function handleHeaderRendered(e, args) {
                ...
                if (menu) {
                    ...
                    $el.bind("click", showMenu).appendTo(args.headerNode);
                }
            }
            ...
            function showMenu(e) {
                ...
                if (!$menu) {
                    $menu = $("<div class='slick-header-menu'></div>").appendTo(document.body);
                }
                $menu.empty();
