define("console/umodel/1.0.0/umodel-debug", ["#jquery/1.8.2/jquery-debug", "#underscore/1.4.2/underscore-debug", "#backbone/0.9.2/backbone-debug", "$-debug"], function(require, exports, module) {
    // require('json/1.0.2/json-debug');
    // require('es5-safe/0.9.2/es5-safe-debug');
